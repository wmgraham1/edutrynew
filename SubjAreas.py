...
class SubjAreaEditList(BaseHandler):
...
#            logging.info('QQQ: count_other_language: %d' % count_other_language)
        ...
        self.render_template('LearnSubjAreaListEdit.html', {'units': units, 'Typ': Typ, 'count_en': count_en, 'count_other_language': count_other_language, 'StatusList':StatusList, 'StatusFilter':StatusFilter, 'languages':languages, 'langCode':langCode, 'langName':langName, 'currentuser':currentuser, 'login':login, 'logout': logout})
...
class SubjAreaEditListPost(BaseHandler):
